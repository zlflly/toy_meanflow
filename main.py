...
from toy_meanflow.data import (BlockDataset, TokenBuffer, build_dataloader)
from toy_meanflow.tokenizer import ByteTokenizer
from toy_meanflow.model import MultiHeadSelfAttention
...
def main() -> None:
    ...
    attention_output = attention(hidden)
    ...
    print("\nOutput is finite:")
    print(torch.isfinite(attention_output).all().item())
